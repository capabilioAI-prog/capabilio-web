...
export const FLAGS = {
  ...
  // maintenance_mode takeover flag below (main.jsx/pages/MaintenancePage.jsx)
  // — this one never blocks the app, the site stays fully usable underneath
  // it. Off by default; flip via
