...
app.use("/api/github",       githubRoutes)       // analyze, connect, disconnect, connection, refresh, verify-ownership, repo-interview, visibility, cross-verify — no background scheduler; every scan is user-initiated (connect or POST /refresh)
